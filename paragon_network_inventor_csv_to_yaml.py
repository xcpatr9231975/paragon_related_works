...
Each router includes default Juniper credentials: jnpr/pass123
"""
...
def convert_csv_to_yaml(csv_file, output_file=None, default_username='jnpr', default_password='pass123'):
    """
...
def print_summary(routers):
    ...
    print(f"Default Credentials: jnpr / pass123")
    print("="*70)
